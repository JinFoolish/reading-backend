...
@router.get('/article', summary='get article detail by article id')
async def article_detail(article_id):
    resp = CommonResponse()
    data = Article.objects(id=ObjectId(article_id)).first()
...
@router.post('/batch_list/article')
